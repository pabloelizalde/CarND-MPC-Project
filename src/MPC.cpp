 ...
 public:
  ...
  void operator()(ADvector& fg, const ADvector& vars) {
    ...
    for (int i = 0; i < N - 1; i++) {
      ...
      //try adding penalty for speed + steering
    ...
    for (int t = 1; t < N; t++) {
      ...
      // Here we have into account the latency included in the main.cpp
      // Since the timestep lenght is the the same than the latency (100ms), we use the actuator at time t - 1
      if (t > 1) {
        a = vars[a_start + t - 2];
